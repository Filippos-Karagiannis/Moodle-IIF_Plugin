...
require_once($CFG->dirroot . '/mod/i3f/backup/moodle2/backup_i3f_stepslib.php');

/**
 * Provides all the settings and steps to perform one complete backup of the activity
 */
class backup_i3f_activity_task extends backup_activity_task {
    ...
    protected function define_my_steps() {
        $this->add_step(new backup_i3f_activity_structure_step('i3f_structure', 'i3f.xml'));
    }
    ...
    static public function encode_content_links($content) {
        ...
        $base = preg_quote($CFG->wwwroot.'/mod/i3f','#');
