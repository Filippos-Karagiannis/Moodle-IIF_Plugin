...
$event = \mod_i3f\event\course_module_instance_list_viewed::create($params);
$event->add_record_snapshot('course', $course);
$event->trigger();

$strurl       = get_string('modulename', 'i3f');
$strurls      = get_string('modulenameplural', 'i3f');
$strname         = get_string('name');
$strintro        = get_string('moduleintro');
$strlastmodified = get_string('lastmodified');

$PAGE->set_url('/mod/i3f/index.php', array('id' => $course->id));
...
if (!$urls = get_all_instances_in_course('i3f', $course)) {
...
foreach ($urls as $url) {
    ...
    $table->data[] = array (
        ...
        format_module_intro('i3f', $url, $cm->id));
}
